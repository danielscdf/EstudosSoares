CREATE OR REPLACE VIEW vw_071_zeresima_mun
AS SELECT vw.cd_pleito,
       ...
       SUM(CASE
               ...
               ELSE
                0
           END) over(PARTITION BY vw.cd_eleicao, vw.sg_ue_mun) qt_total_chapas,
       ...
       vw.nm_federacao
			...
			LEFT JOIN ft_votos_votavel_municipio vv
						...
						AND vv.sq_dm_municipio = mz.sq_dm_municipio
