CREATE OR REPLACE VIEW vw_071_zeresima_zona
AS SELECT vw.cd_pleito,
       ...
       SUM(CASE
               ...
               ELSE
                0
           END) over(PARTITION BY vw.cd_eleicao, vw.sg_ue_mun, vw.nr_zona) qt_total_chapas,
...
LEFT JOIN ft_votos_votavel_mun_zona vv
      ...
      AND vv.sq_dm_mun_zona = mz.sq_dm_mun_zona
