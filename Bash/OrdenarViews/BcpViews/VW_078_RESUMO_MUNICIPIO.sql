CREATE OR REPLACE VIEW vw_078_resumo_municipio(cd_pleito,
                                                             cd_eleicao,
    ...
    (SELECT v.cd_pleito,
       ...
       to_char(CASE
                   ...
                   WHEN qtd_comparecimento = 0 THEN
                    0
                   WHEN qtd_comparecimento / qtd_aptos_urnas_instaladas * 100 BETWEEN 0.0000000000000001 AND 0.001 THEN
                    0.01
                   ELSE
                    trunc(qtd_comparecimento / qtd_aptos_urnas_instaladas * 100, 2)
               END,
       ...
       to_char(CASE
                   WHEN qtd_aptos_urnas_instaladas = 0 THEN
                    0
                   WHEN qtd_abstencao = 0 THEN
                    0
                   WHEN qtd_comparecimento / qtd_aptos_urnas_instaladas * 100 BETWEEN 0.0000000000000001 AND 0.001 THEN
                    100 - 0.01
                   ELSE
                    100 - trunc(qtd_comparecimento / qtd_aptos_urnas_instaladas * 100, 2)
               END,
               '990D00') pe_abstencao,
...
FROM vw_078_resumo_secoes_mun v
