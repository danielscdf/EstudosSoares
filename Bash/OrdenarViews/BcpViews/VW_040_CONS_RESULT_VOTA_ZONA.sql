CREATE OR REPLACE VIEW vw_040_cons_result_vota_zona
AS
...
INNER JOIN vw_ft_votos_votavel_mun_zona vv
...
INNER JOIN vw_ft_secoes_mun_zona se
ON se.cd_pleito = dm.cd_pleito
   ...
   AND se.sq_dm_mun_zona = dm.sq_dm_mun_zona
