BEGIN
EXECUTE IMMEDIATE 'DROP MATERIALIZED VIEW VM_VOTAVEL_CANDIDATO_RESPOSTA';
...
CREATE MATERIALIZED VIEW ADMTOTCENTRAL.VM_VOTAVEL_CANDIDATO_RESPOSTA
...
SELECT v.cd_pleito,
             ...
             SELECT v.cd_pleito,
                    ...
                    v.sg_ue_uf
               FROM votavel v
                    JOIN resposta r --Nâo existe índice para essa combinação de parâmetros, avaliar a possibilidade de criar.
