CREATE OR REPLACE VIEW vw_040_cons_result_vota_mun
AS
SELECT ca.nr_votavel numero,
       ...
       ca.nr_partido,
       ca.sq_drap,
       nvl(ca.nm_coligacao, ca.nm_partido)nm_partido_coligacao,
       ...
       CASE WHEN ca.nm_coligacao IS NOT NULL THEN 'C'
            ...
            ELSE 'P'
       END tp_agremiacao
FROM vw_ft_votos_votavel_municipio vv
...
INNER JOIN vw_ft_secoes_municipio se
